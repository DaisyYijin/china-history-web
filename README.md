...
一个纯静态、开箱即用的**中华通史可视化网站**：从炎黄传说到当代中国，涵盖 **469 位关键人物、225 个重大事件、451 组人物关系**，其中 84 个事件附有**交战双方兵力对比**，154 位主力人物附**逐年生平大事记**（逾千条）。完美适配桌面端与移动端。
...
- **人物关系图谱**：ECharts 力导向图，节点按 29 个阵营着色，节点大小代表关联度；可按阵营筛选、显示全部人名与连线关系文字；**悬停某个人物：仅该人物原地定住**（金环放大、连线标注“甲 — 关系 — 乙”），其余人物继续飘动；悬停连线则两端人物定住；**标签字号随滚轮缩放同步缩放**，放大后文字依然清晰；点击节点查看人物详情。
...
│   ├── era-culture.js      # 文化名人批量扩充（诗人/名医/书画/文豪）
│   ├── people-timeline.js  # 人物逐年生平大事记（主体）
│   └── timelines-2.js      # 年谱第二批（三国/英烈/民国文化）
